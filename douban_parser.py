...
LastEditTime: 2023-05-08 16:18:29
...
class Douban_parser:
            ...
            for key, value in xpath_dict.items():
                ...
                if len(temp) > 0:
                    if value['tag'] == 'text':
                        ...
                        temp = temp[0].attrs[value['tag']] if temp[0].attrs[value['tag']] else ''
                    result[key] = temp
        except Exception as e:
            print(e.__traceback__.tb_frame.f_globals["__file__"].split("/")[-1], e.__traceback__.tb_lineno, e)
            return {}
        else:
            return result
    ...
    def book_parser(self, url:str, is_render:bool=False) -> dict:
        try:
            ...
            xpath_dict = {
                'name': {
                    'xpath': '/html/body/div[3]/h1/span',
                    'tag': 'text'
                },
                'cover': {
                    'xpath': '//*[@id="mainpic"]/a/img',
                    'tag': 'src'
                },
                'author': {
                    'xpath': '//*[@id="info"]/span[1]/a',
                    'tag': 'text'
                },
                'rating_num': {
